...
export const NewlyIcon = () => (
  <svg width={baselineIconSize} height={baselineIconSize} fill="none" viewBox="0 59.17 284 156.07">
    <path fill="#A9C1EA" d="m78.893 59.167 15.774 15.608L78.893 90.383l-15.786 -15.62zm31.548 31.216 15.774 15.608 -15.774 15.608 -15.774 -15.62zm126.226 0 15.774 15.608 -15.774 15.608 -15.786 -15.62zm31.548 31.216L284 137.208l-15.786 15.608 -15.774 -15.62zm-31.548 31.217 15.774 15.596 -15.774 15.62 -15.786 -15.62zm-31.559 31.204 15.786 15.62 -15.786 15.596 -15.775 -15.609zm-31.548 -31.204 15.773 15.596 -15.786 15.62 -15.774 -15.62zM47.333 90.383l15.774 15.608 -15.774 15.608 -15.774 -15.62z"/>
    <path fill="#1671F1" d="m205.107 59.167 15.786 15.608 -142 140.462L0 137.208l15.774 -15.62 63.119 62.433z" />
  </svg>
)
export const LimitedIcon = () => (
  <svg width={baselineIconSize} height={baselineIconSize} viewBox="0 0 500 284" fill="none">
    <path fill="#EA8600" d="M142.007 0 222 80l-34 34-79.993-80 34-34ZM108 250 358 0l34 34-250 250-34-34ZM391.992 250 312 170l-34 34 79.992 80 34-34Z" />
    <path fill="#FDD663" d="M108.007 34 142 68l-74 74 74 74-34 34L0 142 108.007 34ZM358 68l74 74-74 74 33.992 34L500 142 392 34l-34 34Z" />
  </svg>
)
...
export const CheckIcon = () => (
  <svg width={browserStatusIconSize} height={browserStatusIconSize} viewBox="0 0 24 24" fill="currentColor">
...
export const ChromeIcon = ({ active }: { active: boolean }) => (
  ...
  height={browserIconSize}
    ...
    style={{ fill: active ? '#4285F4' : '#9aa0a6' }}
  >
    <circle cx="12" cy="12" r="10" />
    <title>Chrome {active ? 'Available' : 'Unavailable'}</title>
  </svg>
)
...
export const FirefoxIcon = ({ active }: { active: boolean }) => (
  ...
  height={browserIconSize}
    viewBox="0 0 24 24"
    className={`browser-icon ${active ? 'active' : ''}`}
    style={{ fill: active ? '#FF7139' : '#9aa0a6' }}
  >
    <circle cx="12" cy="12" r="10" />
    <title>Firefox {active ? 'Available' : 'Unavailable'}</title>
  </svg>
)
...
export const EdgeIcon = ({ active }: { active: boolean }) => (
  ...
  height={browserIconSize}
    viewBox="0 0 24 24"
    className={`browser-icon ${active ? 'active' : ''}`}
    style={{ fill: active ? '#0078D7' : '#9aa0a6' }}
  >
    <circle cx="12" cy="12" r="10" />
    <title>Edge {active ? 'Available' : 'Unavailable'}</title>
  </svg>
)
...
export const SafariIcon = ({ active }: { active: boolean }) => (
  ...
  height={browserIconSize}
    viewBox="0 0 24 24"
    className={`browser-icon ${active ? 'active' : ''}`}
    style={{ fill: active ? '#00ACED' : '#9aa0a6' }}
  >
    <circle cx="12" cy="12" r="10" />
    <title>Safari {active ? 'Available' : 'Unavailable'}</title>
  </svg>
)
